...
$sql = "select * FROM lent_info where auction_count < 3 and start_region = '$region' and (together_flag < 1 or (together_flag > 0 and current_user_count > 19)) ORDER BY lent_num desc";
