...
import com.bustacall.user.bustacall.view.Fragment_Main_Go;
 ...
 */
public class Fragment_Main_Go_Presenter {
    Fragment_Main_Go view;
    public Fragment_Main_Go_Presenter(Fragment_Main_Go view){
        this.view = view;
    }
