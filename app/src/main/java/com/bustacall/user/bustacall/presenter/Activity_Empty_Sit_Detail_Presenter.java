...
import com.bustacall.user.bustacall.view.Activity_Empty_Sit_Detail;
 ...
 */
public class Activity_Empty_Sit_Detail_Presenter {
    Activity_Empty_Sit_Detail view;
    AppController app;
    public Activity_Empty_Sit_Detail_Presenter(Activity_Empty_Sit_Detail view){
        this.view = view;
